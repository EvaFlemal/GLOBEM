...
feature_types = ['ACTIVITY', 'STEP', 'SIGNIFICANT_MOTION', 'GRAVITY', "LIGHT", "APPUSAGE", "CALL", "EMA", "KEYSTROKE", "NOTIFICATIONS", "SCREEN_STATE", "SOUND", "TYPING", "UNLOCK_STATE"]
...
def set_feature_columns(sep = ":", epochs = wks_epoch8):
    ...
    fc_repo.feature_columns_fulldict = {
        "ACTIVITY": ['RUNNING_count', 'RUNNING_duration', 'RUNNING_proportion', 'ON_BICYCLE_count', 'ON_BICYCLE_duration', 'ON_BICYCLE_proportion', 'IN_VEHICLE_count', 'IN_VEHICLE_duration', 'IN_VEHICLE_proportion', 'WALKING_count', 'WALKING_duration', 'WALKING_proportion', 'STILL_count', 'STILL_duration', 'STILL_proportion'],
        "STEP": ['count', 'count2std'],
        "SIGNIFICANT_MOTION": ['count', 'elapsed_time'],
        "GRAVITY": ['X_mean', 'X_min', 'X_max', 'X_std', 'X_kurtosis', 'X_skewness', 'Y_mean', 'Y_min', 'Y_max', 'Y_std', 'Y_skewness', 'Y_kurtosis', 'Z_mean', 'Z_min', 'Z_max', 'Z_std', 'Z_skewness', 'Z_kurtosis'],
        "LIGHT": ['count_0', 'BRIGHTNESS_LOG_mean', 'BRIGHTNESS_LOG_min', 'BRIGHTNESS_LOG_max', 'BRIGHTNESS_LOG_std', 'BRIGHTNESS_LOG_kurtosis', 'BRIGHTNESS_LOG_skewness'],
        "APPUSAGE": ['entropy', 'normalized_entropy', 'COMMUNICATION_count', 'COMMUNICATION_duration', 'SOCIAL_count', 'SOCIAL_duration', 'HEALTH_count', 'HEALTH_duration', 'ENTERTAINMENT_count', 'ENTERTAINMENT_duration', 'LIFESTYLE_count', 'LIFESTYLE_duration', 'BOOKS_count', 'BOOKS_duration', 'VIDEO_count', 'VIDEO_duration', 'FINANCE_count', 'FINANCE_duration', 'PHOTOGRAPHY_count', 'PHOTOGRAPHY_duration', 'PRODUCTIVITY_count', 'PRODUCTIVITY_duration'],
        "CALL": ['count_ratio_in2missed', 'count_ratio_in2out', 'duration_ratio_in2out', 'IN_duration', 'OUT_duration', 'MISSED_count', 'IN_count', 'OUT_count'], 
        "EMA": ['sleep_trouble', 'poor_appetite'],
        "KEYSTROKE": ['SOCIAL_backspace_ratio', 'SOCIAL_autocorrect_ratio', 'SOCIAL_autocorrect_accept_ratio', 'SOCIAL_count_sessions', 'SOCIAL_interkeyDelay_mean', 'NON-SOCIAL_backspace_ratio', 'NON-SOCIAL_autocorrect_ratio', 'NON-SOCIAL_count_sessions', 'NON-SOCIAL_autocorrect_accept_ratio', 'NON-SOCIAL_interkeyDelay_mean'], 
        "NOTIFICATIONS": ['SOCIAL_ARRIVED_count', 'SOCIAL_CLICKED_count', 'SOCIAL_DECISION_TIME_count', 'SOCIAL_DECISION_TIME_duration_in_sec', 'SOCIAL_count_ratio_clicked2arrived', 'SOCIAL_count_ratio_decided2arrived', 'NON-SOCIAL_ARRIVED_count', 'NON-SOCIAL_CLICKED_count', 'NON-SOCIAL_DECISION_TIME_count', 'NON-SOCIAL_DECISION_TIME_duration_in_sec', 'NON-SOCIAL_count_ratio_clicked2arrived', 'NON-SOCIAL_count_ratio_decided2arrived'],
        "SCREEN_STATE": ['on_count', 'off_count', 'entropy', 'normalized_entropy', 'total_duration', 'mean_duration', 'check_count'],
        "SOUND": ['ENERGY_mean', 'ENERGY_min', 'ENERGY_max', 'ENERGY_std', 'ENERGY_kurtosis', 'ENERGY_skewness'],
        "TYPING":  ['SOCIAL_count', 'SOCIAL_total', 'SOCIAL_mean', 'SOCIAL_std', 'SOCIAL_min', 'SOCIAL_max', 'SOCIAL_kurtosis', 'SOCIAL_skewness', 'NON-SOCIAL_count', 'NON-SOCIAL_total', 'NON-SOCIAL_mean', 'NON-SOCIAL_std', 'NON-SOCIAL_min', 'NON-SOCIAL_max', 'NON-SOCIAL_kurtosis', 'NON-SOCIAL_skewness'],
        "UNLOCK_STATE": ['unlock_count', 'lock_count', 'entropy', 'normalized_entropy', 'total_duration', 'mean_duration'],
    }
    # fc_repo.feature_columns_fulldict = {
